...
from interface.navier_stokes_interface import NavierStokesInterface
from interface.laser_interface import LaserWindow
from ui.numerisation_options import NumerationOptionsWindow
from interface.data_science_interface import DataScienceInterface
from interface.energy_interface import EnergyInterface
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ns_interface = NavierStokesInterface()
        self.data_science_window = DataScienceInterface()
        self.energy_window = EnergyInterface()
